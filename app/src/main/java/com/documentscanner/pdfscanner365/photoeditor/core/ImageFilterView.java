...
import com.documentscanner.pdfscanner365.photoeditor.core.GLToolbox;
...
import com.documentscanner.pdfscanner365.photoeditor.core.TextureRenderer;

import static android.media.effect.EffectFactory.*;
import static com.documentscanner.pdfscanner365.photoeditor.core.PhotoFilter.*;
...
class ImageFilterView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private com.documentscanner.pdfscanner365.photoeditor.core.CustomEffect mCustomEffect;
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        renderResult();
        if (isSaveImage) {
            final Bitmap mFilterBitmap = com.documentscanner.pdfscanner365.photoeditor.core.BitmapUtil.createBitmapFromGLSurface(this, gl);
    ...
    private void loadTextures() {
        ...
        if (mSourceBitmap != null) {
            ...
            com.documentscanner.pdfscanner365.photoeditor.core.GLToolbox.initTexParams();
        }
    }

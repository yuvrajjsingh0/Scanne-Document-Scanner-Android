...
class GraphicManager {
    ...
    public void addView(com.documentscanner.pdfscanner365.photoeditor.core.Graphic graphic) {
    ...
    public void removeView(com.documentscanner.pdfscanner365.photoeditor.core.Graphic graphic) {
        View view = graphic.getRootView();
    ...
    public boolean undoView() {
        if (mViewState.getAddedViewsCount() > 0) {
            ...
            if (removeView instanceof com.documentscanner.pdfscanner365.photoeditor.core.BrushDrawingView) {
                com.documentscanner.pdfscanner365.photoeditor.core.BrushDrawingView brushDrawingView = (com.documentscanner.pdfscanner365.photoeditor.core.BrushDrawingView) removeView;
    ...
    public boolean redoView() {
        if (mViewState.getRedoViewsCount() > 0) {
            ...
            if (redoView instanceof com.documentscanner.pdfscanner365.photoeditor.core.BrushDrawingView) {
                com.documentscanner.pdfscanner365.photoeditor.core.BrushDrawingView brushDrawingView = (BrushDrawingView) redoView;

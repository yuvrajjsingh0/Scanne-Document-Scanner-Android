...
import com.documentscanner.pdfscanner365.photoeditor.core.BitmapUtil;
...
class PhotoSaverTask extends AsyncTask<String, String, PhotoSaverTask.SaveResult> {
    ...
    private @Nullable
    com.documentscanner.pdfscanner365.photoeditor.core.PhotoEditor.OnSaveListener mOnSaveListener;
    private @Nullable
    com.documentscanner.pdfscanner365.photoeditor.core.OnSaveBitmap mOnSaveBitmap;
    private final com.documentscanner.pdfscanner365.photoeditor.core.PhotoEditorView mPhotoEditorView;
    ...
    public PhotoSaverTask(PhotoEditorView photoEditorView, com.documentscanner.pdfscanner365.photoeditor.core.BoxHelper boxHelper) {
    ...
    private Bitmap buildBitmap() {
        return mSaveSettings.isTransparencyEnabled()
                ? com.documentscanner.pdfscanner365.photoeditor.core.BitmapUtil.removeTransparency(captureView(mPhotoEditorView))

...
abstract class Graphic {
    ...
    protected MultiTouchListener.OnGestureControl buildGestureController(final ViewGroup viewGroup, final PhotoEditorViewState viewState) {
        final com.documentscanner.pdfscanner365.photoeditor.core.BoxHelper boxHelper = new com.documentscanner.pdfscanner365.photoeditor.core.BoxHelper(viewGroup, viewState);
